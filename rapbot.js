...
app.get('/', function (req, res) {
  ...
  _.when(
    ...
    _.when(stuffToDo).done(function () {
      cypher += "<br>*drops the mic*<br><br><a href=\"\">Yo, reload for more!</a> | <button id='rap' onclick='rap()'>MAKE IT RAP (works in Chrome)</button> | <span id='info' style='display:none'>Track: <a href='"+ beatUrl +"'>" + beatName  + " by " + beatAuthor + "</a>, used under a " + license + " license.</span><br><a href=\"https://github.com/dariusk/rapbot/blob/master/howitworks.md\">how it works</a> | <a href=\"https://github.com/dariusk/rapbot\">source code</a> | <a href=\"http://developer.wordnik.com\">thank u based Wordnik</a>";
